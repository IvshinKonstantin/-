// File: AutoParkSystem.cs
// Этот файл содержит все классы системы управления автопарком
// Использует EPPlus версии 4.5.3.3 (не требует лицензии)
using System;
...
namespace AutoParkSystem
{
    ...
    public class DatabaseManager
    {
        ...
        // на автомобилях моложе 10 лет в 2023 году
